state("Post Void") {
	double lvlID: 0x04B2780, 0x2C, 0x10, 0x240, 0x1B0;
	double igtFull: 0x04B2780, 0x2C, 0x10, 0x36C, 0x120;
	double igtLvl: 0x04B2780, 0x2C, 0x10, 0x18C, 0x50;
	//double kills: 0x04B2780, 0x2C, 0x10, 0x18, 0xB0;
	//double hits: 0x04B2780, 0x2C, 0x10, 0x18, 0x90;
	//double shots: 0x04B2780, 0x2C, 0x10, 0x18, 0x80;
	//double headshots: 0x04B2780, 0x2C, 0x10, 0x18, 0x70;
	//double hitsTaken: 0x04B2780, 0x2C, 0x10, 0x18, 0x50;
	//double inGameScore: 0x0128AE8, 0x50, 0x21C, 0x318, 0x0;
}
