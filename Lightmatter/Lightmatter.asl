state("LightmatterSub") {
  int start_value  : "fmodstudio.dll", 0x2B3CF0, 0x110, 0x10, 0x0, 0x28;
  int level_number : "mono-2.0-bdwgc.dll", 0x490A68, 0x50, 0x140, 0x58, 0xA0;
  // float total_timer: "mono-2.0-bdwgc.dll", 0x490A68, 0x50, 0x180, 0x0, 0xF8, 0x4;
  int switches     : "mono-2.0-bdwgc.dll", 0x490A68, 0x50, 0x180, 0x0, 0xF8, 0x40;
  float level_timer: "mono-2.0-bdwgc.dll", 0x492DE8, 0x100, 0x0, 0x60, 0x90;
}
