...
startup {
	...
	var sB = new List<Tuple<string, string, bool, string>> {
		...
		tB("v2.0", "inLevelSplits2.0", false, "In-Level Splits:"),
			...
			tB("inLevelSplits2.0", "frameSplits2.0", false, "Splits in Main Frame:"),
			...
			tB("inLevelSplits2.0", "centSplits2.0", false, "Splits in Centrifuge:"),
		...
		tB("v1.1", "inLevelSplits1.1", false, "Other Splits:"),
			...
			tB("inLevelSplits1.1", "frameSplits1.1", false, "Splits in Main Frame:"),
